...
export default class SelectCurrency extends Component {
  ...
  handleChangeFrom = event => {
    this.setState({ fromxx: event.target.value });
    this.value = event.target.value;
    //console.log(this.value);
  };
  handleChangeTo = event => {
    this.setState({ toxx: event.target.value });
    this.value = event.target.value;
    //console.log(this.value);
  };
  handleCclick = () => {
    this.myApi = `https://www.alphavantage.co/query?function=CURRENCY_EXCHANGE_RATE&from_currency=${
      this.state.fromxx
    }&to_currency=${this.state.toxx}&apikey=033X8KBM2MWLUQ34`;
  ...
  render() {
    return (
      <div className="linedive divStyle">
        <select className="myinput" onChange={this.handleChangeFrom}>
        ...
        /
        <select className="myinput" onChange={this.handleChangeTo}>
          <option defaultValue="">Select currency</option>
          <option value="USD">America (United States) Dollars – USD</option>
          <option value="AFN">Afghanistan Afghanis – AFN</option>
          <option value="ALL">Albania Leke – ALL</option>
        ...
        <button className="buttonStyle" onClick={this.handleCclick}>
